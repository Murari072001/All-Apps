...
function LoginForm()
{
    ...
    return (
    <div className="login rounded-3 border border-3 border-dark p-2">
        <h2>Login</h2>
        ...
        <form ref={l} className="" onSubmit={LoginFormik.handleSubmit}>
            ...
            <div className="form-floating m-2">
                <input type="email" name="username" id="username" placeholder="username" className="form-control bg-transparent" onChange={LoginFormik.handleChange} onBlur={LoginFormik.handleBlur} />
                <label htmlFor="username">Enter Your Username</label>
            </div>
            {LoginFormik.touched.password&&<b className="text-danger">{LoginFormik.errors.password}</b>}
            <div className="form-floating m-2">
                <input type="password" name="password" id="password" placeholder="password" className="form-control bg-transparent" onChange={LoginFormik.handleChange} onBlur={LoginFormik.handleBlur} />
